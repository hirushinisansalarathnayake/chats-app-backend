...
describe('paginate', () => {
    ...
    it('should return result based on sort on embedded entity when other relations loaded', async () => {
        ...
        const copyToys = catToysWithoutShop.map((toy) => {
    ...
    it('should return result based on sort on embedded entity on one-to-many relation', async () => {
        ...
        const result = await (0, paginate_1.paginate)(query, catRepo, config);
        const toy0 = (0, lodash_1.clone)(catToysWithoutShop[0]);
        delete toy0.cat;
        const toy1 = (0, lodash_1.clone)(catToysWithoutShop[1]);
        delete toy1.cat;
        const toy2 = (0, lodash_1.clone)(catToysWithoutShop[2]);
        delete toy2.cat;
        const toy3 = (0, lodash_1.clone)(catToysWithoutShop[3]);
        delete toy3.cat;
        const orderedCats = [
            Object.assign((0, lodash_1.clone)(cats[6]), { toys: [] }),
            Object.assign((0, lodash_1.clone)(cats[5]), { toys: [] }),
    ...
    it('should return result based on sort on embedded entity on one-to-one relation', async () => {
        ...
        const result = await (0, paginate_1.paginate)(query, catHomeRepo, config);
        const orderedHomes = (0, lodash_1.clone)([catHomes[1], catHomes[0], catHomes[2]]);
    ...
    it('should return result based on search term on embedded entity when other relations loaded', async () => {
        ...
        copyCat.home = null;
        copyCat.toys = [];
        const copyCat2 = (0, lodash_1.clone)(cats[5]);
        copyCat2.home = null;
        copyCat2.toys = [];
    ...
    it('should return result based on search term on embedded entity on one-to-one relation', async () => {
        ...
        const result = await (0, paginate_1.paginate)(query, catHomeRepo, config);
        const catHomeClone = (0, lodash_1.clone)(catHomes[1]);
    ...
    it('should return result based on filter on embedded entity', async () => {
        const config = {
            ...
            searchableColumns: ['size.height'],
            filterableColumns: {
                'size.height': [filter_1.FilterSuffix.NOT],
            },
        };
        const query = {
            path: '',
    ...
    it('should return result based on filter on embedded entity when other relations loaded', async () => {
        ...
        const copyCats = [
            ...
            Object.assign((0, lodash_1.clone)(cats[5]), { home: null }),
            Object.assign((0, lodash_1.clone)(cats[6]), { home: null }),
        ];
    ...
    it('should return result based on filter on embedded on many-to-one relation', async () => {
        const config = {
            ...
            sortableColumns: ['id', 'name'],
            filterableColumns: {
                'cat.(size.height)': [filter_1.FilterSuffix.NOT],
            },
        };
        const query = {
            path: '',
    ...
    it('should return result based on filter on embedded on one-to-many relation', async () => {
        const config = {
            ...
            sortableColumns: ['id', 'name'],
            filterableColumns: {
                'toys.(size.height)': [filter_1.FilterOperator.EQ],
            },
        };
        const query = {
            path: '',
    ...
    it('should return result based on filter on embedded on one-to-one relation', async () => {
        const config = {
            ...
            sortableColumns: ['id', 'name'],
            filterableColumns: {
                'cat.(size.height)': [filter_1.FilterOperator.EQ],
            },
        };
        const query = {
            path: '',
    ...
    it('should return result based on $in filter on embedded on one-to-one relation', async () => {
        const config = {
            ...
            sortableColumns: ['id', 'name'],
            filterableColumns: {
                'cat.(size.height)': [filter_1.FilterOperator.IN],
            },
        };
        const query = {
            path: '',
    ...
    it('should return result based on $btw filter on embedded on one-to-one relation', async () => {
        const config = {
            ...
            sortableColumns: ['id', 'name'],
            filterableColumns: {
                'cat.(size.height)': [filter_1.FilterOperator.BTW],
            },
        };
        const query = {
            path: '',
        ...
        const catHomeClones = (0, lodash_1.clone)(catHomes);
        catHomeClones[0].countCat = cats.filter((cat) => cat.size.height >= 18 && cat.size.height <= 33 && cat.id == catHomeClones[0].cat.id).length;
        catHomeClones[1].countCat = cats.filter((cat) => cat.size.height >= 18 && cat.size.height <= 33 && cat.id == catHomeClones[1].cat.id).length;
        catHomeClones[2].countCat = cats.filter((cat) => cat.size.height >= 18 && cat.size.height <= 33 && cat.id == catHomeClones[1].cat.id).length;
    ...
    it('should return result based on multiple filter', async () => {
        const config = {
            ...
            filterableColumns: {
                name: [filter_1.FilterSuffix.NOT],
                color: [filter_1.FilterOperator.EQ],
            },
        };
        const query = {
            path: '',
    ...
    it('should return result based on $ilike filter', async () => {
        const config = {
            sortableColumns: ['id'],
            filterableColumns: {
                name: [filter_1.FilterOperator.ILIKE],
            },
        };
        const query = {
            path: '',
    ...
    it('should return result based on $sw filter', async () => {
        const config = {
            sortableColumns: ['id'],
            filterableColumns: {
                name: [filter_1.FilterOperator.SW],
            },
        };
        const query = {
            path: '',
    ...
    it('should return result based on filter and search term', async () => {
        const config = {
            ...
            searchableColumns: ['name', 'color'],
            filterableColumns: {
                id: [filter_1.FilterSuffix.NOT, filter_1.FilterOperator.IN],
            },
        };
        const query = {
            path: '',
    ...
    it('should return result based on range filter', async () => {
        const config = {
            sortableColumns: ['id'],
            filterableColumns: {
                age: [filter_1.FilterOperator.GTE],
            },
        };
        const query = {
            path: '',
    ...
    it('should return result based on between range filter', async () => {
        const config = {
            sortableColumns: ['id'],
            filterableColumns: {
                age: [filter_1.FilterOperator.BTW],
            },
        };
        const query = {
            path: '',
    ...
    it('should return result based on is null query', async () => {
        const config = {
            sortableColumns: ['id'],
            filterableColumns: {
                age: [filter_1.FilterOperator.NULL],
            },
        };
        const query = {
            path: '',
    ...
    it('should return result based on not null query', async () => {
        const config = {
            sortableColumns: ['id'],
            filterableColumns: {
                age: [filter_1.FilterSuffix.NOT, filter_1.FilterOperator.NULL],
            },
        };
        const query = {
            path: '',
    ...
    it('should return result based on not null query on relation', async () => {
        const config = {
            sortableColumns: ['id'],
            filterableColumns: {
                'home.street': [filter_1.FilterSuffix.NOT, filter_1.FilterOperator.NULL],
            },
            relations: ['home', 'home.naptimePillow.brand'],
        };
        const query = {
        ...
        const expectedResult = [1, 2].map((i) => {
            const ret = Object.assign((0, lodash_1.clone)(cats[i]), { home: (0, lodash_1.clone)(catHomes[i]) });
            ret.home.countCat = 1;
            delete ret.home.cat;
            return ret;
        });
    ...
    it('should return result based on null query on relation', async () => {
        const config = {
            sortableColumns: ['id'],
            filterableColumns: {
                'home.street': [filter_1.FilterOperator.NULL],
            },
            relations: ['home', 'home.naptimePillow.brand'],
        };
        const query = {
    ...
    it('should return result based on null query on nested relation', async () => {
        const config = {
            sortableColumns: ['id'],
            filterableColumns: {
                'home.naptimePillow.brand.quality': [filter_1.FilterOperator.NULL],
            },
        };
        const query = {
            path: '',
        ...
        expect(result.data).toStrictEqual(expectedResult);
        expect(result.links.current).toBe('?page=1&limit=20&sortBy=id:ASC&filter.home.naptimePillow.brand.quality=$null');
    });
    it('should ignore filterable column which is not configured', async () => {
        const config = {
            sortableColumns: ['id'],
            filterableColumns: {
                name: [filter_1.FilterSuffix.NOT, filter_1.FilterOperator.NULL],
            },
        };
        const query = {
            path: '',
    ...
    it.each([
        ...
        expect((0, filter_1.isOperator)(operator)).toStrictEqual(result);
    });
    it.each([{ suffix: '$not', result: true }])('should check suffix "$suffix" valid is $result', ({ suffix, result }) => {
        expect((0, filter_1.isSuffix)(suffix)).toStrictEqual(result);
    });
    it.each([
        ...
        const func = filter_1.OperatorSymbolToFunction.get(operator);
        expect(func.name).toStrictEqual(name);
    });
    for (const cc of [filter_1.FilterComparator.AND, filter_1.FilterComparator.OR, '']) {
        const comparator = cc === '' ? filter_1.FilterComparator.AND : cc;
    ...
    it('should return result based on two ors and an and with two cats', async () => {
        ...
        const result = await (0, paginate_1.paginate)(query, catRepo, config);
        expect(result.data).toStrictEqual(cats.filter((cat) => (cat.name === 'Milo' || cat.color === 'white') && cat.age));
        expect(result.links.current).toBe('?page=1&limit=20&sortBy=id:ASC&filter.name=$or:Milo&filter.color=$or:white&filter.age=$btw:1,10');
    });
    it('should return result based on two multifilters chained together with and operator', async () => {
        ...
        const result = await (0, paginate_1.paginate)(query, catRepo, config);
        const expected = cats.filter((cat) => (cat.name === 'Milo' || cat.name === 'Garfield') && (cat.color === 'brown' || cat.color === 'white'));
        expect(result.data).toStrictEqual(expected);
        expect(result.links.current).toBe('?page=1&limit=20&sortBy=id:ASC&filter.name=Milo&filter.name=$or:Garfield&filter.color=brown&filter.color=$or:white');
    });
    it('should return result based on two multifilters chained together with or operator', async () => {
        ...
        const expected = cats.filter((cat) => cat.name === 'Milo' || cat.name === 'Garfield' || cat.color === 'brown' || cat.color === 'white');
        expect(result.data).toStrictEqual(expected);
        expect(result.links.current).toBe('?page=1&limit=20&sortBy=id:ASC&filter.name=$or:Milo&filter.name=$or:Garfield&filter.color=$or:brown&filter.color=$or:white');
    });
    it('should return result based on filters chained together with and operators and or operators', async () => {
        ...
        const query = {
            ...
            filter: {
                ...
                age: '$or:$null',
                color: ['brown', '$or:white'],
                cutenessLevel: [cat_entity_1.CutenessLevel.HIGH, `$or:${cat_entity_1.CutenessLevel.LOW}`],
            },
        };
        const result = await (0, paginate_1.paginate)(query, catRepo, config);
        const expected = cats.filter((cat) => (cat.name === 'Milo' || cat.name === 'Garfield' || cat.age === null) &&
            (cat.color === 'brown' || cat.color === 'white') &&
            (cat.cutenessLevel === cat_entity_1.CutenessLevel.HIGH || cat.cutenessLevel === cat_entity_1.CutenessLevel.LOW));
        expect(result.data).toStrictEqual(expected);
        expect(result.links.current).toBe('?page=1&limit=20&sortBy=id:ASC&filter.name=$or:Milo&filter.name=$or:Garfield&filter.age=$or:$null&filter.color=brown&filter.color=$or:white&filter.cutenessLevel=high&filter.cutenessLevel=$or:low');
    });
    ...
    it('should filter nested relations', async () => {
        const config = {
            relations: { home: { pillows: true, naptimePillow: { brand: true } } },
            sortableColumns: ['id', 'name'],
            filterableColumns: { 'home.pillows.color': [filter_1.FilterOperator.EQ] },
        };
        const query = {
            path: '',
    ...
    it('uses custom count builder when provided', async () => {
        const fakeQB = { getCount: jest.fn().mockResolvedValue(42) };
        const config = {
            sortableColumns: ['id'],
            select: ['id', 'name', 'color'],
        ...
        const page = await (0, paginate_1.paginate)(query, catRepo, config);
    ...
    describe('should return result based on date column filter', () => {
        it('with $not and $null operators', async () => {
            const config = {
                sortableColumns: ['id'],
                filterableColumns: {
                    lastVetVisit: [filter_1.FilterSuffix.NOT, filter_1.FilterOperator.NULL],
                },
            };
            const query = {
                path: '',
        ...
        it('with $lt operator', async () => {
            const config = {
                sortableColumns: ['id'],
                filterableColumns: {
                    lastVetVisit: [filter_1.FilterOperator.LT],
                },
            };
            const query = {
                path: '',
            ...
            expect(result.data).toStrictEqual([cats[0]]);
            expect(result.links.current).toBe('?page=1&limit=20&sortBy=id:ASC&filter.lastVetVisit=$lt:2022-12-20T10:00:00.000Z');
        });
        it('with $lte operator', async () => {
            const config = {
                sortableColumns: ['id'],
                filterableColumns: {
                    lastVetVisit: [filter_1.FilterOperator.LTE],
                },
            };
            const query = {
                path: '',
            ...
            expect(result.links.current).toBe('?page=1&limit=20&sortBy=id:ASC&filter.lastVetVisit=$lte:2022-12-20T10:00:00.000Z');
        });
        it('with $btw operator', async () => {
            const config = {
                sortableColumns: ['id'],
                filterableColumns: {
                    lastVetVisit: [filter_1.FilterOperator.BTW],
                },
            };
            const query = {
                path: '',
            ...
            expect(result.data).toStrictEqual([cats[1]]);
            expect(result.links.current).toBe('?page=1&limit=20&sortBy=id:ASC&filter.lastVetVisit=$btw:2022-12-20T08:00:00.000Z,2022-12-20T12:00:00.000Z');
        });
        it('with $eq operator', async () => {
            const config = {
                sortableColumns: ['id'],
                filterableColumns: {
                    lastVetVisit: [filter_1.FilterOperator.EQ],
                },
            };
            const query = {
                path: '',
            ...
            expect(result.links.current).toBe('?page=1&limit=20&sortBy=id:ASC&filter.lastVetVisit=$eq:2022-12-21T10:00:00.000Z');
        });
        it('with $gte operator', async () => {
            const config = {
                sortableColumns: ['id'],
                filterableColumns: {
                    lastVetVisit: [filter_1.FilterOperator.GTE],
                },
            };
            const query = {
                path: '',
            ...
            expect(result.data).toStrictEqual([cats[1], cats[2], cats[6]]);
            expect(result.links.current).toBe('?page=1&limit=20&sortBy=id:ASC&filter.lastVetVisit=$gte:2022-12-20T10:00:00.000Z');
        });
        it('with $gt operator', async () => {
            const config = {
                sortableColumns: ['id'],
                filterableColumns: {
                    lastVetVisit: [filter_1.FilterOperator.GT],
                },
            };
            const query = {
                path: '',
            ...
            expect(result.links.current).toBe('?page=1&limit=20&sortBy=id:ASC&filter.lastVetVisit=$gt:2022-12-20T10:00:00.000Z');
        });
    ...
    if (process.env.DB === 'postgres') {
        describe('should be able to filter on jsonb columns', () => {
            ...
            it('should filter with multiple values', async () => {
                ...
                expect(result.links.current).toBe('?page=1&limit=20&sortBy=id:ASC&filter.metadata.length=$eq:0.5&filter.metadata.thickness=$eq:10');
            });
            it('should filter on a nested property through a relation', async () => {
                ...
                expect(result.links.current).toBe('?page=1&limit=20&sortBy=id:ASC&filter.underCoat.metadata.length=$eq:50');
            });
        });
    }
    if (process.env.DB !== 'postgres') {
    ...
    describe('cursor pagination', () => {
        ...
        describe('sortBy: lastVetVisit', () => {
            ...
            if (process.env.DB !== 'mariadb') {
                it('should handle date type cursor column with zero timestamp (lastVetVisit, ASC)', async () => {
                    ...
                    const zeroDateCat = await catRepo.save(catRepo.create({
                        name: 'ZeroCat',
                        color: 'grey',
                        age: 1,
                        cutenessLevel: cat_entity_1.CutenessLevel.LOW,
                ...
                it('should handle date type cursor column with zero timestamp (lastVetVisit, DESC)', async () => {
                    ...
                    const config = {
                        ...
                        defaultLimit: 2,
                        filterableColumns: {
                            lastVetVisit: [filter_1.FilterOperator.NULL, filter_1.FilterSuffix.NOT],
                        },
                    };
                    const query = {
                        path: '',
                    ...
                    expect(result.links.previous).toBe(`?limit=2&sortBy=lastVetVisit:ASC&filter.lastVetVisit=$not:$null&cursor=X000000000000000`); // lastVetVisit=1970-01-01T00:00:00.000Z, ASC (ZeroCat)
                    expect(result.links.next).toBe(`?limit=2&sortBy=lastVetVisit:DESC&filter.lastVetVisit=$not:$null&cursor=V000000000000000`); // lastVetVisit=1970-01-01T00:00:00.000Z, DESC (ZeroCat)
                    // Clean up
                    await catRepo.remove(zeroDateCat);
                });
            }
        ...
        describe('sortBy: age, lastVetVisit', () => {
            it('should handle multiple cursor columns checking sorted data (age:ASC, lastVetVisit:ASC)', async () => {
                ...
                expect(result.links.previous).toBe('?limit=20&sortBy=age:DESC&sortBy=lastVetVisit:DESC&cursor=N00000000000X0000A000000000000000'); // age=0, DESC + lastVetVisit=null, DESC (Baby) -> N + LPAD(0, 11, '0') + X + LPAD(0, 4, '0') + A + LPAD(0, 15, '0')
                expect(result.links.next).toBe('?limit=20&sortBy=age:ASC&sortBy=lastVetVisit:ASC&cursor=A000000000000000A000000000000000'); // age=null, ASC + lastVetVisit=null, ASC (Leche) -> A + LPAD(0, 15, '0') + A + LPAD(0, 15, '0')
            });
            it('should handle multiple cursor columns checking combined cursor (age:ASC, lastVetVisit:ASC)', async () => {
                ...
                expect(result.links.previous).toBe('?limit=4&sortBy=age:DESC&sortBy=lastVetVisit:DESC&cursor=N00000000000X0000A000000000000000'); // age=0, DESC + lastVetVisit=null, DESC (Baby) -> N + LPAD(0, 11, '0') + X + LPAD(0, 4, '0') + A + LPAD(0, 15, '0')
                expect(result.links.next).toBe('?limit=4&sortBy=age:ASC&sortBy=lastVetVisit:ASC&cursor=V99999999996X0000V998328296800000'); // age=4, ASC + lastVetVisit=2022-12-22T10:00:00.000Z, ASC (Adam) -> V + 10^11 - 4 + X + LPAD(0, 4, '0') + V + 10^15 - 1671703200000
                const result2 = await (0, paginate_1.paginate)(Object.assign(Object.assign({}, query), { cursor: 'V99999999996X0000V998328296800000' }), catRepo, config);
                ...
                expect(result2.links.previous).toBe('?limit=4&sortBy=age:DESC&sortBy=lastVetVisit:DESC&cursor=V00000000005V0000V001671530400000'); // age=5, DESC + lastVetVisit=2022-12-20T10:00:00.000Z, DESC (Garfield) -> V + LPAD(5, 11, '0') + V + LPAD(0, 4, '0') + V + LPAD(1671530400000, 15, '0')
                expect(result2.links.next).toBe(`?limit=4&sortBy=age:ASC&sortBy=lastVetVisit:ASC&cursor=A000000000000000A000000000000000`); // age=null, ASC + lastVetVisit=null, ASC (Leche) -> A + LPAD(0, 15, '0') + A + LPAD(0, 15, '0')
            });
            it('should handle multiple cursor columns with different directions (age:DESC, lastVetVisit:ASC)', async () => {
                ...
                expect(result.links.previous).toBe('?limit=20&sortBy=age:ASC&sortBy=lastVetVisit:DESC&cursor=V99999999994X0000V001671444000000'); // age=6, ASC + lastVetVisit=2022-12-19T10:00:00.000Z DESC (Milo) -> V + (10^11 - 6) + X + LPAD(0, 4, '0') + V + LPAD(1671444000000, 15, '0')
                expect(result.links.next).toBe(`?limit=20&sortBy=age:DESC&sortBy=lastVetVisit:ASC&cursor=A000000000000000A000000000000000`); // age=null, DESC + lastVetVisit=null, ASC (Leche) -> A + LPAD(0, 15, '0') + A + LPAD(0, 15, '0')
            });
        });
        describe('handling null and 0 values', () => {
            it('should handle 0 and null distinctly (DESC)', async () => {
                ...
                const result = await (0, paginate_1.paginate)({ path: '', limit: 6 }, catRepo, config);
                const ageNotNullCats = cats.filter((cat) => cat.age !== null);
                ...
                const result2 = await (0, paginate_1.paginate)({ path: '', cursor: 'N00000000000X0000', limit: 6 }, catRepo, config);
            ...
            it('should handle 0 and null distinctly (ASC)', async () => {
                ...
                const result = await (0, paginate_1.paginate)({ path: '', limit: 1 }, catRepo, config);
                ...
                const result2 = await (0, paginate_1.paginate)({ path: '', cursor: 'X00000000000X0000' }, catRepo, config);
        ...
        describe('with other options', () => {
            it('should work with filter and cursor pagination (sortBy id + filter color)', async () => {
                ...
                expect(result.links.previous).toBe('?limit=2&sortBy=id:DESC&filter.color=white&cursor=V00000000004V0000');
            ...
            it('should work with filter and cursor pagination (sortBy id + filter age)', async () => {
                ...
                expect(result.links.previous).toBe('?limit=20&sortBy=id:DESC&filter.age=$not:$null&cursor=V00000000001V0000');
        ...
        describe('handling data including decimal and negative numbers', () => {
            ...
            it('should put null values last', async () => {
                const nullCat = await catRepo.save(catRepo.create({
                    name: 'nullCat',
                    color: 'black',
                    age: null,
                    weightChange: null,
            ...
            it('should handle multiple cursor columns checking sorted data (age:ASC, weightChange:ASC)', async () => {
                ...
                expect(result.links.previous).toBe('?limit=20&sortBy=age:DESC&sortBy=weightChange:DESC&cursor=N00000000000X0000V00000000000V0100'); // age=0, DESC + weightChange=0.01 DESC (Baby) -> (V + LPAD(0, 11, '0')) + (X + LPAD(0, 4, '0')) + (V + LPAD(0, 11, '0')) + (V + LPAD(100, 4, '0'))
                expect(result.links.next).toBe('?limit=20&sortBy=age:ASC&sortBy=weightChange:ASC&cursor=A000000000000000Y00000000001V2500'); // age=null, ASC + weightChange=-1.25 ASC (Leche) -> (A + LPAD(0, 15, '0')) + (Y + LPAD(1, 11, '0')) + (V + LPAD(2500, 4, '0'))
            });
            it('should handle multiple cursor columns with different directions (age:DESC, weightChange:ASC)', async () => {
                ...
                expect(result.links.previous).toBe('?limit=20&sortBy=age:ASC&sortBy=weightChange:DESC&cursor=V99999999994X0000N00000000000V2500'); // age=6, ASC + weightChange=-0.75 DESC (Milo) -> (V + 10^11 - 6) + (X + LPAD(0, 4, '0')) + (N + LPAD(0, 11, '0')) + (V + LPAD(10^4 - 7500), 4, '0'))
                expect(result.links.next).toBe('?limit=20&sortBy=age:DESC&sortBy=weightChange:ASC&cursor=A000000000000000Y00000000001V2500'); // age=null, DESC + weightChange=-1.25 ASC (Leche) -> (A + LPAD(0, 15, '0')) + (Y + LPAD(1, 11, '0')) + (V + LPAD(2500, 4, '0'))
            });
        });
        describe('handling relation column', () => {
            let relationTestCats;
            let relationTestToys;
            let relationTestCatsIds;
            let relationTestToysIds;
            beforeAll(async () => {
            ...
            afterAll(async () => {
                if (relationTestToys === null || relationTestToys === void 0 ? void 0 : relationTestToys.length) {
                    await catToyRepo.remove(relationTestToys);
                }
                if (relationTestCats === null || relationTestCats === void 0 ? void 0 : relationTestCats.length) {
            ...
            it('should handle cursor pagination on many-to-one relation column (cat.age, ASC)', async () => {
                ...
                expect(result.meta.cursor).toBeUndefined();
                expect(result.links.previous).toBe(`?limit=4&sortBy=cat.age:DESC&filter.id=$in:${relationTestToysIds.join(',')}&cursor=V00000000002V0000`);
                expect(result.links.next).toBe(`?limit=4&sortBy=cat.age:ASC&filter.id=$in:${relationTestToysIds.join(',')}&cursor=V99999999996X0000`);
            });
            it('should handle cursor pagination on many-to-one relation column with cursor (cat.age, ASC)', async () => {
                ...
                const firstResult = await (0, paginate_1.paginate)(firstPageQuery, catToyRepo, config);
                ...
                const secondResult = await (0, paginate_1.paginate)(secondPageQuery, catToyRepo, config);
            ...
            it('should handle cursor pagination on many-to-one relation column (cat.age, DESC)', async () => {
                ...
                expect(result.meta.cursor).toBeUndefined();
                expect(result.links.previous).toBe(`?limit=20&sortBy=cat.age:ASC&filter.id=$in:${relationTestToysIds.join(',')}&cursor=V99999999996X0000`);
                expect(result.links.next).toBe(`?limit=20&sortBy=cat.age:DESC&filter.id=$in:${relationTestToysIds.join(',')}&cursor=V00000000002V0000`);
            });
            ...
            it('should handle cursor pagination on one-to-many relation column & embedded entity (toys.(size.height), ASC)', async () => {
                ...
                expect(result.links.previous).toBe(`?limit=20&sortBy=toys.(size.height):DESC&filter.id=$in:${relationTestCatsIds.join(',')}&cursor=V00000000002V0000`);
                expect(result.links.next).toBe(`?limit=20&sortBy=toys.(size.height):ASC&filter.id=$in:${relationTestCatsIds.join(',')}&cursor=V99999999995X0000`);
            });
            it('should handle cursor pagination on one-to-many relation column & embedded entity (toys.(size.height), ASC) for a cat that has more than one toy', async () => {
                ...
                expect(result.links.previous).toBe(`?limit=20&sortBy=toys.(size.height):DESC&filter.id=$in:${relationTestCatsIds.join(',')}&cursor=V00000000005V0000`);
                expect(result.links.next).toBe(`?limit=20&sortBy=toys.(size.height):ASC&filter.id=$in:${relationTestCatsIds.join(',')}&cursor=V99999999994X0000`);
            });
            it('should handle cursor pagination on one-to-many relation column & embedded entity (toys.(size.height), DESC)', async () => {
                ...
                expect(result.links.previous).toBe(`?limit=20&sortBy=toys.(size.height):ASC&filter.id=$in:${relationTestCatsIds.join(',')}&cursor=V99999999994X0000`);
                expect(result.links.next).toBe(`?limit=20&sortBy=toys.(size.height):DESC&filter.id=$in:${relationTestCatsIds.join(',')}&cursor=V00000000002V0000`);
            });
            it('should handle cursor pagination on one-to-one relation column (cat.lastVetVisit, ASC)', async () => {
                ...
                expect(result.links.previous).toBe(`?limit=20&sortBy=cat.lastVetVisit:DESC&filter.id=$in:${relationTestToysIds.join(',')}&cursor=V001668506400000`);
                expect(result.links.next).toBe(`?limit=20&sortBy=cat.lastVetVisit:ASC&filter.id=$in:${relationTestToysIds.join(',')}&cursor=V998330629600000`);
            });
            it('should handle cursor pagination on one-to-one relation column (cat.lastVetVisit, DESC)', async () => {
                ...
                expect(result.links.previous).toBe(`?limit=20&sortBy=cat.lastVetVisit:ASC&filter.id=$in:${relationTestToysIds.join(',')}&cursor=V998330629600000`);
                expect(result.links.next).toBe(`?limit=20&sortBy=cat.lastVetVisit:DESC&filter.id=$in:${relationTestToysIds.join(',')}&cursor=V001668506400000`);
            });
            it('should handle multiple cursor columns with relation (cat.age:ASC, id:DESC)', async () => {
                ...
                expect(result.links.previous).toBe('?limit=20&sortBy=cat.age:DESC&sortBy=id:ASC&cursor=V00000000002V0000V99999999994X0000');
                expect(result.links.next).toBe('?limit=20&sortBy=cat.age:ASC&sortBy=id:DESC&cursor=V99999999994X0000V00000000001V0000');
            });
            it('should handle cursor pagination with filter on relation column', async () => {
                const config = {
                    ...
                    relations: ['cat'],
                    filterableColumns: {
                        'cat.age': [filter_1.FilterOperator.EQ],
                    },
                    defaultLimit: 4,
                };
    ...
    describe('Wildcard Select', () => {
        it('should expand * wildcard to all main entity columns', async () => {
            ...
            const result = await (0, paginate_1.paginate)(query, catRepo, {
                sortableColumns: ['id'],
                select: ['*'],
            });
